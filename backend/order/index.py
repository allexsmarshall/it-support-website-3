...
def handler(event: dict, context) -> dict:
    '''
    Business: Принимает заявку на техническое сопровождение с сайта и отправляет её в Telegram.
    ...
    if not token or not chat_id:
        return {'statusCode': 500, 'headers': cors, 'body': json.dumps({'error': 'Telegram не настроен'})}
